									...
									TSubclassOf<UUserWidget> gearWidget)
{
	...
	Widget_Helmet->ContainerInitSetting(ItemSlotClass, ItemBaseClass, ItemMoveSlotClass, EContainerCategory::Helmet, 2, 2);
	...
	Widget_Cloth->ContainerInitSetting(ItemSlotClass, ItemBaseClass, ItemMoveSlotClass, EContainerCategory::Cloth, 2, 2);
	...
	Widget_Shoes->ContainerInitSetting(ItemSlotClass, ItemBaseClass, ItemMoveSlotClass, EContainerCategory::Shoes, 2, 2);
	...
	Widget_Bag->ContainerInitSetting(ItemSlotClass, ItemBaseClass, ItemMoveSlotClass, EContainerCategory::Bag, 3, 3);
	...
	Widget_Weapon->ContainerInitSetting(ItemSlotClass, ItemBaseClass, ItemMoveSlotClass, EContainerCategory::Weapon, 3, 1);
