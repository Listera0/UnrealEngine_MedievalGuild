									...
									TSubclassOf<UUserWidget> gearWidget)
{
	...
	Widget_Helmet->ContainerInitSetting(ItemSlotClass, ItemBaseClass, ItemMoveSlotClass, 2, 2);
	...
	Widget_Cloth->ContainerInitSetting(ItemSlotClass, ItemBaseClass, ItemMoveSlotClass, 2, 2);
	...
	Widget_Shoes->ContainerInitSetting(ItemSlotClass, ItemBaseClass, ItemMoveSlotClass, 2, 2);
	...
	Widget_Bag->ContainerInitSetting(ItemSlotClass, ItemBaseClass, ItemMoveSlotClass, 3, 3);
	...
	Widget_Weapon->ContainerInitSetting(ItemSlotClass, ItemBaseClass, ItemMoveSlotClass, 3, 1);
